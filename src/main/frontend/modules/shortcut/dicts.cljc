...
(def ^:large-vars/data-var dicts
  {:en (merge
   ...
   :pl {
	...
	:command.dev/show-block-data                     "(Dev) Pokaż dane bloky"
	...
	:command.editor/select-parent                    "Wybierz blok nadrzędny"
	:command.editor/toggle-undo-redo-mode            "Włącz / wyłącz tryb Cofnij Ponów (globalnie lub dla strony)"
	:command.go/all-graphs                           "Idź do wszystkich grafów"
	:command.go/electron-find-in-page                "Znajdź tekst na stronie"
	:command.go/electron-jump-to-the-next            "Przejdź do następnego dopasowania z paska wyszukiwania"
	:command.go/electron-jump-to-the-previous        "Przejdź do poprzediego dopasowania z paska wyszukiwania"
	:command.go/whiteboards                          "Idź do tablic"
	:command.graph/export-as-html                    "Eksportuj publiczne strony grafu jako html"
	:command.pdf/find                                "Pdf: Wyszukaj tekst w aktualnym dokumentcie pdf"
	:command.sidebar/close-top                       "Zamyka górny element na prawym panelu bocznym"
	...
	:command.ui/install-plugins-from-file            "Zainstaluj pluginy z plugins.edn"
        ...
        :command.ui/toggle-contents                      "Przełącz zawartość w panelu bocznym"
